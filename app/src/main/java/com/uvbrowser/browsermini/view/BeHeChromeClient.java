...
public class BeHeChromeClient extends WebChromeClient {
    ...
    boolean isVideoFullscreen; // Indicates if the video is being displayed using a custom view (typically full-screen)

    public BeHeChromeClient(ProgressBar pBar, HeView web, ActionBarActivity act) {
        super();
        mWeb = web;
        PBar = pBar;
        ACTIVITY = act;
