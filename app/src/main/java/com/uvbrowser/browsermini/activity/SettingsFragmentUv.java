...
import com.uvbrowser.browsermini.utils.FileChooseUv;
...
public class SettingsFragmentUv extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pr1.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                PreferenceHelperUv.setIsLookScreen(true);
                return true;
            }
        });
        ...
        pr2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                pr.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        FileChooseUv chos = new FileChooseUv();
                ...
                PreferenceHelperUv.setIsBrowserScreen(true);
                return true;
            }
        });
