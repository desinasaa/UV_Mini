...
package com.uvbrowser.browsermini.adapters;
...
public class BookAdapterUv extends BaseAdapter {
    private Context mContext;
    ArrayList<String>    names;
    ArrayList<String>    urls;
    public BookAdapterUv(Context c, ArrayList<String> etc, ArrayList<String> url) {
        mContext = c;
        names = etc;
        urls = url;
    }
